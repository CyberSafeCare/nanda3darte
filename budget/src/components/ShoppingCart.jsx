...
const ShoppingCart = ({ isCartOpen, setIsCartOpen }) => {
  ...
  const handleCheckout = useCallback(async () => {
    ...
    try {
      ...
      const { url } = await initializeCheckout({ items, successUrl, cancelUrl, locale: 'pt-BR' });
      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-gray-900/80 backdrop-blur-xl shadow-2xl flex flex-col"
